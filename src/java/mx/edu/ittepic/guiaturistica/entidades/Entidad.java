...
public class Entidad implements Serializable {
    ...
    private Serializable nombreentidad;
    ...
    public Entidad(Integer identidad, Serializable nombreentidad) {
        this.identidad = identidad;
    ...
    public Serializable getNombreentidad() {
        return nombreentidad;
    }

    public void setNombreentidad(Serializable nombreentidad) {
        this.nombreentidad = nombreentidad;
    }
    ...
    public String toString() {
        return "ittepic.edu.mx.guiaturistica.entidades.Entidad[ identidad=" + identidad + " ]";
    }
