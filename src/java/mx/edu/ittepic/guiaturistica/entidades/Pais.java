...
public class Pais implements Serializable {
    ...
    private Serializable nombrepais;
    ...
    public Pais(Integer idpais, Serializable nombrepais) {
        this.idpais = idpais;
    ...
    public Serializable getNombrepais() {
        return nombrepais;
    }

    public void setNombrepais(Serializable nombrepais) {
        this.nombrepais = nombrepais;
    }
    ...
    public String toString() {
        return "ittepic.edu.mx.guiaturistica.entidades.Pais[ idpais=" + idpais + " ]";
    }
